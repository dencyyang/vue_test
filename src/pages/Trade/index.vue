  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for=" addressInfo in address" :key="addressInfo.id">
        <span class="username " :class="{selected:addressInfo.isDefault==1}" @click="changeDefault(addressInfo,address)" >{{addressInfo.consignee}}</span>
        <p >
      ...
      <div class="detail">
        ...
        <ul class="list clearFix" v-for="order in orderInfo.detailArrayList" :key="order.skuId">
          <li>
            <img :src="order.imgUrl" style="width:120px;height:120px">
          </li>
          <li>
            <p>
              {{order.skuName}}</p>
    ...
    methods:{
      ...
      async submitOrder(){
        ...
        let data={
          ...
          deliveryAddress: this.userDefaultAddress.fullAdderss,//最终收件人地址
